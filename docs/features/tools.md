...
> 包含表情包管理、经济系统、Minecraft、Steam 及 AI 语音。
...
<div class="custom-card" style="background: var(--vp-c-bg-soft); border: 2px solid #b37feb; padding: 20px; border-radius: 15px; margin-bottom: 25px;">
  ...
  <p style="font-size: 13px; opacity: 0.8; margin-bottom: 15px;">集成审核、溯源、压缩包批量上传的表情管理系统。</p>
...
<div class="custom-card" style="background: var(--vp-c-bg-soft); border-left: 5px solid #fadb14; padding: 20px; border-radius: 10px; margin-bottom: 25px;">
  <h3 style="margin-top: 0; color: #d4b106;">💰 Mizuki 经济榜</h3>
  <p style="font-size: 13px; opacity: 0.8; margin-bottom: 15px;">
    查看群内财富排行与随机事件。<br>
    <a href="https://list.mizuki.top" target="_blank" style="color:#d4b106; font-weight:bold;">👉 点击访问 list.mizuki.top 查看网页版</a>
  </p>

| 功能 | 说明 |
| :--- | :--- |
| **Mizuki 经济榜** | 查看全服/全群财富排行 |
| **随机事件** | 触发随机金币增减事件 |
| **每日签到** | 获取基础金币 |
| **积分查询** | 查看当前持有资产 |
...
<div class="custom-card" style="background: #1b2838; color: #c7d5e0; padding: 20px; border-radius: 15px; margin-bottom: 25px;">
...
<div class="custom-card" style="background: var(--vp-c-bg-soft); border-left: 5px solid #fa8c16; padding: 20px; border-radius: 10px;">
  <h3 style="margin-top: 0; color: #fa8c16;">AI 语音与互动</h3>
  
| 指令 | 说明 |
| :--- | :--- |
| `say [文本]` | 让 Bot 说出文本 (TTS) |
| `切换语音` | 切换 TTS 音色 |
| `签到` | 每日签到领积分 |
| `运势` | 查看今日人品 |
